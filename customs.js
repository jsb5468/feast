...
function JakePaul() {
  ...
  this.attacks.push(new extremeDab(this));
  this.attacks.push(new apologyVideo(this));
  this.attacks.push(new merch(this));
...
function dab(attacker) {
  return {
    attackPlayer: function(defender) {
      return [attacker.description("The") + " dabs on you for " + attack(attacker, defender, attacker.str) + " damage"];
    }, requirements: [
...
function recklessDab(attacker) {
  return {
    attackPlayer: function(defender) {
      return [attacker.description("The") + ", troubled by your resilience to his dabbing, performs a reckless dab on you for " + attack(attacker, defender, attacker.str*2) + " damage", "But he takes " + attack(attacker, attacker, attacker.str/2) + " damage from the recklessness of it all!"];
    }, requirements: [
      function(attacker, defender) { return isNormal(attacker) && isNormal(defender); },
        function(attacker, defender) {
          return attacker.health/attacker.maxHealth < 0.75;
        }
    ],
    priority: 1,
    weight: function(attacker, defender) { return 1.5; }
  };
}
...
function extremeDab(attacker) {
  return {
    attackPlayer: function(defender) {
      ...
      function(attacker, defender) { return isNormal(attacker) && isNormal(defender); },
        function(attacker, defender) {
          return attacker.health/attacker.maxHealth < 0.5;
        }
    ],
    priority: 1,
